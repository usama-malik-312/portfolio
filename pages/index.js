        ...
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              Hello, I'm Usama Bin Tahir,  
                  Full Stack Developer
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
              Experienced in HTML, CSS, JavaScript, React.js, Next Js and Node.js, 
              I create efficient and visually appealing web applications. With a strong problem-solving mindset,
               I deliver high-quality code and stay up-to-date with industry trends.
                {/* <a
